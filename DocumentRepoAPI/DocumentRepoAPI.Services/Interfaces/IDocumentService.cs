...
namespace DocumentRepoAPI.Services.Interfaces
{
    public interface IDocumentService
    {
        ...
        //string AddFile(int userId, byte[] file)
        ...
        //bool ModifyFileAccess(int userId, int fileId, int userId, int accessType)
        ...
        //bool ModifyFileAccess(int userId, int folderId, int[] userIds, int accessType)

        //Revoke particular user only
        // Takes folderId, userId from whoom access need to be revoked and accessType...returns true/false based on the sucess/failure
        //bool ModifyFileAccess(int userId, int folderId, int userId, int accessType)
